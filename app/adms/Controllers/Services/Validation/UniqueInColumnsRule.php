...
/**
 * Classe UniqueInColumsRule.
 * 
 * Esta classe deifine uma regra de validação personalizada para verificar a unicidade de um valor em múltiplas colunas de uma tabela no banco de dados.
...
class UniqueInColumnsRule extends Rule
{
    ...
    /**
     * Verifica se o valor fornecido é único em múltiplas colunas específicas de uma tabela.
     * 
     * @param mixed $value O valor a ser validado.
     * 
     * @return bool Retorna true se o valro for único em todas as colunas especificadas ou igual ao valor de exceção; caso contrário, false.
     * 
