...
final class AddRecoverPasswordToAdmsUsers extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        if($this->hasTable('adms_users')){
            ...
            // Alterar a tabela e adicionaras colunas recover_password e validate_recover_password.
            $table = $this->table('adms_users');
            $table->addColumn('recover_password', 'string',[
                'null'  => true,
                'after' => 'password' // Indica que a coluna será criada após 'password'.
            ])
            ->addColumn('validate_recover_password', 'datetime',[
                'null'  => true,
                'after' => 'recover_password' // Indica que a coluna será craida após 'recover_password'.            
            ])
            ->update();
        }
